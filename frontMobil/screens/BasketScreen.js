          ...
          {Object.entries(groupItemsBasket).map(([key, items]) => (
            <View key={key} className="flex-row items-center space-x-3 bg-white py-2 px-5">
              ...
              <Text className="text-gray-600 text-xs">
                <Currency quantity={items[0]?.price} currency="TND" /> TND
              </Text>
        ...
        <View className="p-5 bg-white mt-5 space-y-4 ">
          <View className="flex-row justify-between">
            ...
            <Text className="text-gray-400">
              <Currency quantity={basketTotal} currency="TND" /> TND
            </Text>
          </View>
          <View className="flex-row justify-between">
            <Text className="text-gray-400">Delivery Fee</Text>
            <Text className="text-gray-400">
              <Currency quantity={13.3} currency="TND" /> TND
            </Text>
          </View>
          <View className="flex-row justify-between">
            <Text className="text-gray-400 font-bold">Order Total</Text>
            <Text className=" text-[#1f1f20] font-extrabold">
              <Currency quantity={basketTotal + 13.3} currency="TND" /> TND
            </Text>
          </View>
