...
namespace TpAPP.Services.Identity.Initializer
{
    public class DbInitializer : IDbInializer
    {
        ...
        public void Initialize()
        {
            ...
            var tamp1 = _userManager.AddClaimsAsync(adminUser, new Claim[]
            {
            ...
            var tamp2 = _userManager.AddClaimsAsync(customerUser, new Claim[]
            {
